...
function BestSellersContent() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            {/* Header */}
            <div className="bg-gradient-to-r from-amber-500 to-[#0F1F35] rounded-lg p-6 mb-6">
            ...
            <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                    <Flame className="w-5 h-5 text-[#1E3A5F]" />
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 p-3">
                            {products.map((product, index) => (
                                <div key={product.id} className="relative">
                                    {index < 3 && (
                                        <div className="absolute top-2 left-2 z-10 w-7 h-7 bg-gradient-to-br from-amber-500 to-[#0F1F35] rounded-full flex items-center justify-center text-white text-xs font-bold shadow-md">
                                            {index + 1}
                                        </div>
                                    )}
