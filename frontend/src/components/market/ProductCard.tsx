...
const toNumber = (v: number | string | null | undefined): number | undefined => {
    ...
    const normalized = typeof v === "number"
        ? v
        : v.includes(",")
            ? v.replace(/\./g, "").replace(",", ".")
            : v;
    const n = typeof normalized === "number" ? normalized : parseFloat(normalized);
    ...
    return (
        <div
            className={cn(
                ...
                "hover:border-primary-500 hover:shadow-lg transition-all duration-150 overflow-hidden",
        ...
        >
            ...
            >
                ...
                <div
                    className={cn(
                        "relative bg-white flex items-center justify-center flex-shrink-0 border-b border-neutral-100",
                ...
                >
                    ...
                    {!badge && hasDiscount && discountPct !== null && discountPct > 0 && (
                ...
                <div className={cn("flex-1 p-3 sm:p-4 flex flex-col gap-2 min-w-0", isLarge && "lg:p-6 lg:gap-3")}>
                    ...
                    <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex shrink-0 items-center gap-1.5">
                            {product.offers_count && product.offers_count > 1 && (
                                <span className="rounded-sm bg-primary-50 px-2 py-0.5 text-[11px] font-bold text-primary-700 tabular-num">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        <div className="rounded-sm border border-neutral-200 bg-neutral-50 px-2.5 py-2">
                            <span className="block text-[10px] font-bold uppercase text-neutral-500">
                                PSF
                            </span>
                            <span
                                className={cn(
                                    "block font-black text-primary-900 tabular-num",
                                    isLarge ? "text-2xl" : "text-lg sm:text-xl"
                                )}
                            >
                        ...
                        <div className="rounded-sm border border-accent-500/35 bg-accent-bg px-2.5 py-2">
                    ...
                    {hasDiscount && discountPct !== null && discountPct > 0 && (
                        <div className="inline-flex w-fit items-center gap-1.5 rounded-sm bg-success-bg px-2 py-1 text-[11px] font-bold text-success">
                            <TrendingDown className="h-3.5 w-3.5" />
                            PSF&apos;ye göre %{discountPct} avantaj
                        </div>
                    )}
                        ...
                        >
                            <span className="truncate">
                                {product.offers_count && product.offers_count > 0
                                    ? `Teklifleri karşılaştır (${product.offers_count})`
