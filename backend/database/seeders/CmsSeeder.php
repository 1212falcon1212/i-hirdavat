...
class CmsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $heroBanners = [
            [
                'title' => 'Bosch Bahar Kampanyası',
                'subtitle' => 'Profesyonel matkap ve taşlamalarda %20\'ye varan bayi indirimi',
                'badge_text' => '%20 İNDİRİM',
                'image_path' => 'banners/hero-bosch-spring.jpg',
                'link_url' => '/market/marka/bosch',
                'button_text' => 'Kampanyayı İncele',
                'location' => 'home_hero',
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                'title' => 'Makita Akülü Seri',
                'subtitle' => '18V LXT akülü matkap, vidalama ve taşlama setlerinde özel fiyat',
                'badge_text' => 'YENİ SEZON',
                'image_path' => 'banners/hero-makita-cordless.jpg',
                'link_url' => '/market/marka/makita',
            ...
            [
                ...
                'image_path' => 'banners/hero-safety.jpg',
